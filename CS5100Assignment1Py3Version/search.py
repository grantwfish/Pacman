...
def depthFirstSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        for child, nsew, distance in problem.getSuccessors(xy):
            if not child in traveled:
                fringe.push((child, direction + [nsew], traveled + [xy] ))
                path = direction + [nsew]
...
def uniformCostSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        if xy not in alreadyTraversed:
            ...
            for child, next, cost in problem.getSuccessors(xy):
                fringe.push((child, direction + [next], traveled + cost), traveled + cost )
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not fringe.isEmpty():
        ...
        if xy not in alreadyTraversed:
            ...
            for child, next, cost in problem.getSuccessors(xy):
                h = traveled + cost
                fringe.push((child, direction + [next], h), h + heuristic(child, problem))
